...
X.Cultivation=Object.freeze({version:'0.29.0',routes:routes.map(r=>Object.freeze({...r,ids:Object.freeze(r.ids)})),requirements:Object.freeze([7,11,15,20,24])});
...
Run.prototype.end=function(reason){if(this.state==='ended')return;end.call(this,reason);Object.assign(this.result,{dao:this.dao,realm:this.realm,masteredCount:this.masteredCount(),realmHistory:(this.realmHistory||[]).map(x=>({...x})),version:'0.29.0'});};
